  ...
  return (
    ...
    <Modal opened={opened} onClose={close} title="اضافة مهمة جديدة" className='p-10 gap-y-8'>
        ...
        <label className='w-full flex flex-col items-end justify-start gap-y-[0.88rem]'>
            ...
            <input name='name' placeholder='ادخل عنوان المهمة' className='text-right w-full placeholder:text-right px-[0.75rem] py-[0.62rem] shadow-inner-shadow placeholder:text-black-1/70 rounded-[0.375rem] border border-blue-1'/>
          </label>


          <label className='flex flex-col justify-end items-end w-full gap-y-4'>
          <span>الوصف</span>
          <textarea name='description' className='w-full text-right placeholder:text-right resize-none border border-blue-1 rounded-[0.375rem] px-[0.75rem] py-[0.62rem] h-[9.375rem]'  placeholder='...ادخل الوصف'></textarea>
          </label>
